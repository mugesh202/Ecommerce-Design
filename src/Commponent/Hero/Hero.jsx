            ...
            <div className='Container grid grid-cols-1 md:grid-cols-2 min-h-[650px] relative  '>
                <div className='flex items-center justify-center w-[1280px] py-14 md:py-0 relative z-10'>
                    <div className='text-center md:text-left space-y-5  lg:max-w-[400px]'>
                        ...
                        initial="hidden"
                        animate="visible"
                        className='text-4xl lg:text-5xl font-bold leading-relaxed xl:leading-loose font-averia '>Healthy<br />
                        ...
                        <motion.p 
                         ...
                         initial="hidden"
                         animate="visible"className='text-gray-400'>Healthy and yummy food for fresh morning
                            breakfast. Eat Daily for Good Health and
                            mind Order now and get 20% off on your first
                            order.
                        </motion.p>
                        <motion.div 
                    ...
                    <div className='absolute top-14 md:top-0 right-1/2 blur-sm opacity-80 rotate-[40deg]'>
                        ...
                        initial={{opacity:0, x:-200, rotate:75}}
                        animate={{opacity:1, x:0, rotate:0}}
                        transition={{duration:1, delay:1.5}}src={LeafPng} alt="" className='w-full md:max-w-[300px]' />
                    </div>
                </div>
            </div>
        </section>
